...
//written by: Ridwan Khan
//Tested by: Mhammed Alhayek, Ridwan Khan, Shubhra Paradkar, Lauren Williams
//debugged by: Ridwan Khan

	
$keyZipLC = "AIzaSyAFd0n6zIrq0Xscr4Wq5eKdUBBIeobFoJs"; //Mo Zip code APi key
//$keyGeoCodLC = "AIzaSyAn4WHKnArDlLswqx47mjkBRmFbTgtvoxk"; //Ridwan gmail API key -- I accidently bounced ridwans when i was testing, - Mo
$keyGeoZip = "AIzaSyBHHotUySVfCduC-qH6j_aKsIYAcb5qqWE"; //Ridwan Scarlet Mail API key
$keyGeoCodLC = "AIzaSyAlBMDX_003UZi4CymMxqth659og3jzwAA"; 		// i replaced it with this when i bounced it
...
function callLocServHeat($locParams) {
	...
	//echo("gonna attempt to print lat/lng on next lines");
	//echo("myLat is: ".$myLat); 
