...
class success_elem{
    ...
    public $gas_api_valid;
    public $expected_output;

    function __construct($a1,$a2,$a3,$a4,$a5,$a6,$a7){
        $this->input_valid = $a1;
        $this->zip_api_valid = $a2;
        $this->forecast_api_valid = $a3;
        $this->loc_api_valid = $a4;
        $this->gas_api_valid = $a5;
        $this->route_api_valid = $a6;        
        $this->expected_output = $a7;
    }
...
//example params for route feature, including gas cost 
    $userParams = array(
        "which_feature" => "route",
...
//example params for route feature, including weather forecast
    $userParams = array(
        ...
        "forecast"      => true,
        "time"          => 17,
        //this is the date 4 days from today
        "day"           => date('F j, Y', strtotime('+'.'4'.' day')),
        "weather"       => "",
        "show_gas"      => false,
    );
...
//example params for heatmap feature
    $userParams = array(
...
//the params for heatmap feature, including weather forecast
    $userParams = array(
...
function instantiate_route_cond(){
    ...
    $success_element = new success_elem(0,0,0,0,0,0,"invalid input");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,0,0,0,$invalid_arr,0,"invalid gas api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,0,0,0,$valid_arr,$invalid_arr,"invalid route");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,0,0,0,$valid_arr,$valid_arr,"success");
    array_push($output_matrix,$success_element);
...
function instantiate_forecasted_route_cond(){
    ...
    $success_element = new success_elem(true,$invalid_arr,0,0,0,0,"invalid zip code api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,$valid_arr,$invalid_arr,0,0,0,"invalid weather api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,$valid_arr,$valid_arr,0,$valid_arr,$invalid_arr, "invalid route api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,$valid_arr,$valid_arr,0,$valid_arr,$valid_arr,"success");
    array_push($output_matrix,$success_element);
...
function instantiate_heatmap_cond(){
    ...
    $success_element = new success_elem(true,0,0,$invalid_arr,0,0,"invalid location api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,0,0,$valid_arr,0,0,"success");
    array_push($output_matrix,$success_element);
...
function instantiate_forecasted_heatmap_cond(){
    ...
    //these are all permutations of execution conditions
    $success_element = new success_elem(false,0,0,0,0,0,"invalid inputs");
    array_push($output_matrix,$success_element);
    ...
    $success_element = new success_elem(true,$valid_arr,$valid_arr,$invalid_arr,0,0,"invalid location api");
    array_push($output_matrix,$success_element);

    $success_element = new success_elem(true,$valid_arr,$valid_arr,$valid_arr,0,0,"success");
    array_push($output_matrix,$success_element);
