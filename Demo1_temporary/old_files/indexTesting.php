                      ...
                      <form id="frm1" action="" method="post" class="form-horizontal">
                        ...
                        <!--</div>-->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10"> 
                              <input type="text" id = "startLoc" name="startLoc" class="form-control" value = '<? echo $startingAdd ?>' required>
                            </div>
                          </div> 
                           <div class="form-group">
                          ...
                          <div class="form-group">
                             ...
                             <div class="col-lg-offset-4 col-lg-9">
                                <input type="submit" value = "View Route" name = "submit" id = "submit" class="btn btn-primary" ></input>
                               <p id="demo"></p>
                             </div>
                          </div>
                      </form>
