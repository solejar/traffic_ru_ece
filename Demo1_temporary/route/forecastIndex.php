                      ...
                      <form id="frm1" action="" method="post" class="form-horizontal">
                          <div class="form-group">
                            <div class="col-lg-offset-4 col-lg-9">
                              <a href="http://onwardtraffic.com/route" class="btn btn-default">Back</a>
                             <p id="demo"></p>
                            </div>
                          </div>
                              ...
                              <input type="text" id = "loc2" name="loc2" class="form-control" value = '<? echo $loc2 ?>' required>
                                         ...
                                         <input type="checkbox" name="forecast"value="false">Forecast</label>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-offset-4 col-lg-9">
                                                <button type="submit" value = "forecasted_route" name = "submit" id = "submit" class="btn btn-primary" >View Route</button>
                                               <p id="demo"></p>
                                             </div>
                                          </div>
                                      </form>
