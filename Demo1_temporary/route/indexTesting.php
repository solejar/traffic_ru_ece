...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start Heat Map-->
            <a href="../route" class="logo">Route <span class="lite">Analysis </span></a>
            <!--logo end-->
      </header>      
      <!--header end-->
      <!--sidebar start-->
                      ...
                      <form id="frm1" action="" method="post" class="form-horizontal">
                        ...
                        <!--</div>-->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10"> 
                              <input type="text" id = "loc1" name="loc1" class="form-control" value = '<? echo $startingAdd ?>' required>
                            </div>
                          </div> 
                           <div class="form-group">
                            <label class="control-label col-lg-2" for="title">Ending Address</label>
                            <div class="col-lg-10"> 
                              <input type="text" id = "loc2" name="loc2" class="form-control" value = '<? echo $stoppingAdd ?>' required>
                            </div>
                          </div>   
                          <!-- Cateogry -->
                          <div class="form-group">
                          ...
                          <div class="form-group">
                             ...
                             <div class="col-lg-offset-4 col-lg-9">
                                <input type="submit" value = "route" name = "submit" id = "submit" class="btn btn-primary" ></input>
                               <p id="demo"></p>
                             </div>
                          </div>
                      </form>
